...
<html lang="vi">
    <head class="active">
        ...
        <script src="<?php echo BASE_URL ?>/js/owl.carousel.min.js?<?php echo VERSION_DATE ?>" type="text/javascript"></script>
        <script src="<?php echo BASE_URL ?>/js/moment.js?<?php echo VERSION_DATE ?>" type="text/javascript"></script>
        <script src="<?php echo BASE_URL ?>/js/bootstrap-datetimepicker.min.js?<?php echo VERSION_DATE ?>" type="text/javascript"></script>
        <script src="<?php echo BASE_URL ?>/js/jquery.elevatezoom.js?<?php echo VERSION_DATE ?>" type="text/javascript"></script>
        <!--//script zoom product-->
        <script src="<?php echo BASE_URL ?>/js/jquery.scrollUp.min.js?<?php echo VERSION_DATE ?>" type="text/javascript"></script>
    ...
    <body>
        ...
        <a id="scrollUp" href="<?php echo BASE_URL ?>/#top" style="position: fixed; z-index: 2147483647;"><i class="fa fa-angle-up"></i></a>
